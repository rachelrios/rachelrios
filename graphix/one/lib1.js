...
var fragmentShaderHeader = [''                      // WHATEVER CODE WE WANT TO PREDEFINE FOR FRAGMENT SHADERS
...
function gl_start(canvas, vertexShader, fragmentShader) {           // START WEBGL RUNNING IN A CANVAS
   ...
   setTimeout(function() {
	 ...
	 gl.program = program;
         ...
         var aPos = gl.getAttribLocation(program, 'aPos');                      // Set aPos attribute for each vertex.
